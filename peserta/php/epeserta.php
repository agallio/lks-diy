<?php
	...
	$sql = "UPDATE peserta SET peserta_nama='$nama',peserta_no='$no',peserta_tgl='$tgl',peserta_sekolah='$sekolah',peserta_kls='$kelas',peserta_id_lomba='$lomba' WHERE peserta_id='$id' ";
